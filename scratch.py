...
parser.add_argument('--resolution',
                    ...
                    default='1280x720')
parser.add_argument('--mode', help='headless or onscreen depending on availability of X console', default='headless')
...
while True:
    ...
    # Acquire frame and resize to expected shape [1xHxWx3] of the model
    frame = frame1.copy()
